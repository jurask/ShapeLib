...
class CrossPads(pya.PCellDeclarationHelper):
  ...
  def display_text_impl(self):
    return "PaddedCross(L={}, PL={}, W={}, PW={})".format(self.cl, self.pl, self.cw, self.pw)
  ...
  def coerce_parameters_impl(self):
    ...
    if self.pw < 0:
      self.pw *= -1
    if self.b1 < self.cl*2+self.pl*2:
      self.b1 = self.cl*2+self.pl*2
    if self.b2 < self.cl*2+self.pl*2:
      self.b2 = self.cl*2+self.pl*2
    if self.cl_ != self.cl or self.pl_ != self.pl or self.cw_ != self.cw or self.pw_ != self.pw or self.b1_ != self.b1 or self.b2_ != self.b2:
      # update handle
